            ...
            <div className={`border-14 border-black p-8 text-black transition-all duration-700 hover:shadow-xl ${hasBeenInView ? 'animate-slide-right' : 'opacity-0'}`}>
              ...
              <div className="space-y-6">
                ...
                <a
                  ...
                  className="w-full flex items-center justify-start gap-4 p-4 border-2 border-white text-black font-mono font-bold uppercase hover:border-black  transition-all duration-300 transform hover:scale-[1.02]"
                >
