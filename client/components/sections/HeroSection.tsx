      ...
      <div className="relative z-10 text-center max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          <button
            ...
            className="px-8 py-3 border-3 border-black bg-white text-black font-mono font-bold uppercase hover:bg-black hover:text-white transition-all duration-200"
          >
            View Timeline
          </button>
          <button
            onClick={scrollToAbout}
            className="px-8 py-3 bg-[#00C853] text-black border-3 border-[#00C853] font-mono font-bold uppercase hover:bg-black hover:border-black transition-all duration-200"
          >
            Read the Forecast
          </button>
        </div>
