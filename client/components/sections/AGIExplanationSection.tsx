    ...
    <div className="border-2 border-black p-6 bg-white hover:shadow-lg transition-all duration-300 group hover:bg-[#f9fff7]">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <h4 className="font-mono text-lg font-bold text-black uppercase mb-2">
            {title}
          </h4>
          ...
          <ul className="space-y-2">
            {details.map((detail, idx) => (
              <li key={idx} className="flex items-start gap-2">
                <span className="text-[#00C853] font-bold mt-1 flex-shrink-0">
                  ›
                </span>
  ...
  const agiConcepts: AGIConceptProps[] = [
    {
      ...
      title: "What is AGI?",
      description:
        "Artificial General Intelligence represents a system capable of understanding, learning, and applying knowledge across diverse domains at or beyond human level.",
      details: [
    ...
    },
    {
      ...
      description:
        "Today's AI systems are specialized (narrow) - excelling in specific domains but lacking general reasoning and transfer capabilities.",
      details: [
    ...
    },
    {
      ...
      description:
        "We track AGI readiness through benchmark categories that assess key dimensions of artificial intelligence.",
      details: [
    ...
    },
    {
      ...
      title: "Path to AGI",
      description:
        "The trajectory toward AGI involves scaling models, improving reasoning, reducing hallucinations, and enabling real-time interaction with systems.",
      details: [
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <p className="font-sans text-gray-700 mt-4">
            A comprehensive guide to Artificial General Intelligence and the
            metrics tracking our progress toward this milestone
          </p>
        </div>

        {/* Core Definition */}
        <div
          className={`border-4 border-black p-8 bg-white mb-12 transition-all duration-700 ${hasBeenInView ? "animate-slide-up" : "opacity-0"}`}
          style={{ transitionDelay: "100ms" }}
        >
          <h3 className="font-mono text-2xl font-bold text-black uppercase mb-4">
            The AGI Definition
          </h3>
          <p className="font-sans text-gray-700 leading-relaxed mb-4">
            Artificial General Intelligence (AGI) is a hypothetical form of AI
            that would have the ability to understand, learn, and apply
            knowledge across a wide range of domains with human-level or
            superhuman capability. Unlike current narrow AI systems—which excel
            in specific tasks—AGI would possess cognitive flexibility,
            adaptability, and reasoning capabilities that enable it to handle
            novel problems in diverse fields without task-specific retraining.
          </p>
          <p className="font-sans text-gray-700 leading-relaxed">
            The transition to AGI would represent a fundamental shift in
            technology's relationship with human capability, potentially serving
            as a gateway to artificial superintelligence (ASI) and transforming
            nearly every aspect of human civilization.
          </p>
        </div>
            ...
            {agiConcepts.map((concept, index) => {
              ...
              return (
                <div
                  ...
                  style={{
                    animationName: hasBeenInView ? "slide-up" : "none",
        ...
        <div
          className={`border-4 border-black p-8 bg-[#f9fff7] transition-all duration-700 mb-12 ${hasBeenInView ? "animate-fade-in" : "opacity-0"}`}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h4 className="font-mono text-lg font-bold text-[#00C853] uppercase mb-4">
        ...
        {/* Timeline Context */}
        <div
          className={`grid grid-cols-1 md:grid-cols-3 gap-6 transition-all duration-700 ${hasBeenInView ? "animate-slide-up" : "opacity-0"}`}
          style={{ transitionDelay: "500ms" }}
        >
          <div className="border-2 border-black p-6 bg-white hover:shadow-lg transition-all duration-300">
            <p className="font-mono text-sm uppercase font-bold text-[#00C853] mb-3">
              Near Term (2025-2027)
            </p>
            <ul className="space-y-2">
              <li className="font-sans text-xs text-gray-700">
        ...
        >
          <p className="font-sans text-sm text-gray-700">
            <span className="font-bold">Project Axis Mission:</span> We track
            and analyze the progress toward AGI to provide transparency and
            insight into this critical moment in human history. Our benchmarks
            reflect current consensus on AGI readiness metrics.
          </p>
        </div>
      </div>
    </section>
